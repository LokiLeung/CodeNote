...
![6f2244046b4da73d170a13f14e3c79d](./C:/Users/12236/AppData/Roaming/Typora/draftsRecover/【Android系统启动】 Android Init 进程启动流程源码解析.assets/6f2244046b4da73d170a13f14e3c79d.jpg)
...
sequenceDiagram
	activate Main
	opt
		Main ->>+ Main : setAsan/HwAasa
		deactivate Main
	end
	Main ->>+ Main : setpriority
	deactivate Main
	
	Main ->>+ FirstStage : FirstStageMain
	FirstStage -->>- Main : 
	
	Main ->>+ SeLinux : SetupSelinux
	SeLinux -->>- Main : 
	
    Main ->>+ SeLinux : SecondStageMain
	SeLinux -->>- Main : 
